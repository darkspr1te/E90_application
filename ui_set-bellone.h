...
public:
    ...
    BellSetOne->resize(QSize(270, 120).expandedTo(BellSetOne->minimumSizeHint()));
    ...
    lblBackground->setText(QApplication::translate("BellSetOne", "", 0, QApplication::UnicodeUTF8));
    ...
    txtBellTime->setInputMask(QApplication::translate("BellSetOne", "", 0, QApplication::UnicodeUTF8));
    txtBellLength->setText(QApplication::translate("BellSetOne", "0", 0, QApplication::UnicodeUTF8));
    comboBellType->clear();
    comboBellType->addItem(QApplication::translate("BellSetOne", "BellType-1", 0, QApplication::UnicodeUTF8));
    Q_UNUSED(BellSetOne);
    } // retranslateUi
