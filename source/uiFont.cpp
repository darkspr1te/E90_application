...
#define uistr_MENU_COMMSETTING_PCBACKPORT	QObject::tr("2.4.13.PCBackPort")
...
#define uistr_ENROLLSETP1_ID		    QObject::tr("ENROLLSETP1_ID")
#define uistr_ENROLLSETP1_NAME		    QObject::tr("ENROLLSETP1_NAME")
#define uistr_ENROLLSETP1_LEVEL		    QObject::tr("ENROLLSETP1_LEVEL")
#define uistr_ENROLLSETP1_FINGER	    QObject::tr("ENROLLSETP1_FINGER")
#define uistr_ENROLLSETP1_CARD		    QObject::tr("ENROLLSETP1_CARD")
#define uistr_ENROLLSETP1_PWD		    QObject::tr("ENROLLSETP1_PWD")
...
#define uistr_REMOTE_ATTENDANCE            QObject::tr("REMOTE_ATTENDANCE")
#define uistr_REMOTE_ATTENDANCE_FUN    QObject::tr("REMOTE_ATTENDANCE_FUN")
#define uistr_REMOTE_DATA_SAVE_TIME     QObject::tr("REMOTE_DATA_SAVE_TIME")
...
void FONTDATABASE_INIT()
{
	...
	__STRINGTABLE->append(uistr_MENU_COMMSETTING_PCBACKPORT);
	...
	__STRINGTABLE->append(uistr_ENROLLSETP1_ID);
	__STRINGTABLE->append(uistr_ENROLLSETP1_NAME);
	__STRINGTABLE->append(uistr_ENROLLSETP1_LEVEL);
	__STRINGTABLE->append(uistr_ENROLLSETP1_FINGER);
	__STRINGTABLE->append(uistr_ENROLLSETP1_CARD);
	__STRINGTABLE->append(uistr_ENROLLSETP1_PWD);

	__STRINGTABLE->append(uistr_PRESS_VERIFY_GET_DATA);          //是否从服务器获取指纹模板到本地？
	...
	__STRINGTABLE->append(uistr_ENROLL_GET_NAME_FAIL);          //获取姓名失败；系统无此号码，不允许继续注册
       ...
       __STRINGTABLE->append(uistr_REMOTE_ATTENDANCE);
	__STRINGTABLE->append(uistr_REMOTE_ATTENDANCE_FUN);
	__STRINGTABLE->append(uistr_REMOTE_DATA_SAVE_TIME);
