...
enum
{
	...
	ARM_CMD_GET_ENROLL_DATA = 0x101,
	ARM_CMD_SET_ENROLL_DATA,
	...
	ARM_CMD_POWER_OFF,
	ARM_CMD_MODIFY_PRIVILIGE,
	ARM_CMD_READ_ALL_USERID,
	ARM_CMD_SERIAL_NUM_GET,
	ARM_CMD_CLEAR_KEEPER_DATA,
