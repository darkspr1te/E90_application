...
public:
	...
	int DoNumInputProcess();  
	DWORD DoNumIpInputProcess(); 
	DWORD DoNumDateInputProcess();
	DWORD DoNumTimeInputProcess();
	DWORD DoNumBellInputProcess();
	DWORD DoNumDaylightInputProcess();
...
public Q_SLOTS:
	...
	void OnBtnOK_NUM();      
    void OnBtnOK_NUMIP();    
	void OnBtnOK_NUMDATE(); 
	void OnBtnOK_NUMTIME();
	void OnBtnOK_NUMBELL();
	void OnBtnOK_NUMDAYLIGHT(); 
	void OnBtnESC();
