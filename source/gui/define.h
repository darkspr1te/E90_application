...
#define DIALOGBOX_RETSTR(_class_)	({QString _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoProcess(); delete __OBJ;} _ret_;})  
#define DIALOGBOX_RETNUM(_class_)	({int _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoNumInputProcess(); delete __OBJ;} _ret_;})   
#define DIALOGBOX_RETNUMIP(_class_)	({DWORD _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoNumIpInputProcess(); delete __OBJ;} _ret_;})  
#define DIALOGBOX_RETNUMDATE(_class_)	({DWORD _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoNumDateInputProcess(); delete __OBJ;} _ret_;})  
#define DIALOGBOX_RETNUMTIME(_class_)	({DWORD _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoNumTimeInputProcess(); delete __OBJ;} _ret_;}) 
#define DIALOGBOX_RETNUMBELL(_class_)	({DWORD _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoNumBellInputProcess(); delete __OBJ;} _ret_;}) 
#define DIALOGBOX_RETNUMDAYLIGHT(_class_)	({DWORD _ret_=0; _class_ *__OBJ = new _class_; if (__OBJ) { __OBJ->show(); _ret_=__OBJ->DoNumDaylightInputProcess(); delete __OBJ;} _ret_;})  
