...
{
	const char* str = "eng: unknown error\r\n";
...
// To the library
//
static volatile int __ENGINE_STATUS = 0;
static volatile long __ENGINE_PARAMS[6];
//////////////////////////////////////////////////////////////////////////
...
// 	__ENGINE_STATUS = fnSB_fp((int)param[0], param[1], param[2], param[3], param[4], param[5]);
	...
	while (1)
	{
		if (__ENGINE_STATUS == 0x08060320)
			__ENGINE_STATUS = fnSB_fp((int)__ENGINE_PARAMS[0], __ENGINE_PARAMS[1], __ENGINE_PARAMS[2], __ENGINE_PARAMS[3], __ENGINE_PARAMS[4], __ENGINE_PARAMS[5]);
		DelayMiliSecond(10);
	}
}
...
{
//	POST_EVENTS();
//	if (g_uiProcStatus.bVerifying || FuncNo != FP_CAPTUREFINGER)
		return fnSB_fp(FuncNo, Param1, Param2, Param3, Param4, Param5);
	__ENGINE_PARAMS[0] = FuncNo;
	__ENGINE_PARAMS[1] = Param1;
	__ENGINE_PARAMS[2] = Param2;
	__ENGINE_PARAMS[3] = Param3;
	__ENGINE_PARAMS[4] = Param4;
	__ENGINE_PARAMS[5] = Param5;

	__ENGINE_STATUS = 0x08060320;
	while (__ENGINE_STATUS == 0x08060320)
	{
